<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFilm.aspx.cs" Inherits="IMDBOzan.WEB.AddFilm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Film <%=Request.QueryString["ID"]==null?"Ekle":"Düzenle"%></title>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h1 style="background-color: darkcyan; text-align: center">Film <%=Request.QueryString["ID"]==null?"Ekle":"Düzenle"%></h1>
            ...
            <table class="table table-bordered table-responsive">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtFilmName" CssClass="form-control" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtFilmDescription" CssClass="auto-style1" runat="server" Height="163px" Width="1141px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
